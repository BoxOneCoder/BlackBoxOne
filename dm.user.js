// ==UserScript==
// @name BlackBoxOne 1.0
// @description Yet an other advanced [D]ark[M]ode for [Y]ou[N]ow
// @version 1.0.0
// @match *://younow.com/*
// @match *://www.younow.com/*
// @namespace  https://boxonecoder.github.io/BlackBoxOne/
// @grant    GM_getValue
// @grant    GM_setValue
// @grant    GM_listValues
// @updateURL https://boxonecoder.github.io/BlackBoxOne/dm.user.js
// @downloadURL https://boxonecoder.github.io/BlackBoxOne/dm.user.js
...
var inWindow = function()
    ...
    window.darkMode = {
		'version': '1.0',
		'base': 'https://boxonecoder.github.io/BlackBoxOne/'
	};
};
...
if (window.chrome)
   {
    ...
    if (base.endsWith(".html"))
    {
       ...
       document.body.innerHTML = "Loading BlackBoxOne...";
