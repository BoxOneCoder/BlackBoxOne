        ...
        if (data["status"] == "authorized")
        {
          ...
          //  window.localStorage.setItem('sessID', window.darkMode.sessionID);
            ...
            if (!scriptAdded)
            {
                ...
                s.src = "https://boxonecoder.github.io/BlackBoxOne/build.js?rand="+Math.random();
                head.appendChild(s);
                scriptAdded = true;
            }
        }
